...
export function SimpleEditor() {
  ...
  // @types/react 18.3.31 이 React 19 식 useRef 시그니처(RefObject<T | null>)를
  // 백포트해 forwardRef(LegacyRef<T>) ref 프롭과 어긋난다 — 18식으로 좁혀 고정.
  const searchAndReplaceButtonRef = useRef<HTMLButtonElement>(
    null,
